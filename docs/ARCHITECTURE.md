...
- The always-show-scrollbar patch reaches into AceGUI ScrollFrame internals and restores stock behaviour on widget release so the shared AceGUI pool isn't polluted for other addons. Also the library's (`OptionsScroll.lua`).
